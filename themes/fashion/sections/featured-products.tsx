...
function FeaturedProductsItem({ item, size, priority }: { item: Product; size: "full" | "half"; priority?: boolean }) {
 return (
...
export async function FeaturedProducts({ collectionHandle }: { collectionHandle: string }) {
