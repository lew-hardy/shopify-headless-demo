...
export function Hero({
  ...
  return (
    <section className="relative w-full">
      ...
      <div
        className={`absolute inset-0 flex items-center px-6 md:hidden ${mobileAlignmentClasses}`}
      >
      ...
      <div
        className={`absolute inset-0 hidden items-center px-6 md:flex ${desktopAlignmentClasses}`}
      >
        <div className="max-w-xl">
          {title && (
            <h1 className="text-4xl font-bold text-white sm:text-6xl">
